let personalAccountInterface_vm = new Vue({
    ...
    mounted(){
        ...
        //获取所有该用户的通知消息
        axios.get("/shaohuashuwu/transactionInfoController/getAllConsumptionTransactionInfo").then(resp =>{
        ...
        //获取用户金豆数量
        axios.get("/shaohuashuwu/userInfoController/getGoldBeanNum").then(response_getGoldBeanNum =>{
        ...
        //获取用户推荐票数量
        axios.get("/shaohuashuwu/userInfoController/getTicketNum").then(response_getTicketNum =>{
