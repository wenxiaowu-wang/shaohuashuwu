    ...
    methods: {
        ...
        normalLogin() {
            ...
            if (this.userInfo.password === "") {
                ...
                axios.get('/shaohuashuwu_war_exploded/userInfoController/userLogin/' +
                    ...
                    if (loginResult === false) {
                        ...
                        this.smsCode = '0';
                        axios.get("/shaohuashuwu_war_exploded/userSession/saveUserPhoneNumber/" +
                       ...
                       // 获取用户数据
                        axios.get('/shaohuashuwu_war_exploded/userInfoController/getUserIdNameAndHeaderByPhone/' +
                            ...
                            //保存到userSession
                            axios.post("/shaohuashuwu_war_exploded/userSession/savePersonalData/" +
        ...
        sendSms() {
                ...
                axios.get('/shaohuashuwu_war_exploded/smsCodeSession/loginSendSms/' +
            ...
            if (this.phone_number === "") {
                ...
                axios.get('/shaohuashuwu_war_exploded/smsCodeSession/compareSms/' +
                    ...
                    if (compareResult === false) {
                        ...
                        axios.get('/shaohuashuwu_war_exploded/userInfoController/userLogin2/' +
                            this.phone_number).then(response => {
                            let loginResult = response.data;
                            console.log(typeof (loginResult));
                            if (loginResult === false) {
                                ...
                                axios.get('/shaohuashuwu_war_exploded/userInfoController/getUserIdNameAndHeaderByPhone/' +
                                    ...
                                    axios.post("/shaohuashuwu_war_exploded/userSession/savePersonalData/" +
                                        ...
                                        // window.location.assign("../pages/myHomePage.html");
                                        window.location.assign("../pages/rsfskdjjsdjgjsdjgjsdlgjsldjgjilsjdglsj.html");
                                    }).catch(error => {
                                        console.log("用户数据同步session失败。"+error);
                                    });
                                }).catch(error => {
