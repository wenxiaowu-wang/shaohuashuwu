    ...
    methods: {
        ...
        updatePersonData() {
            if (this.user_name === "") {
                ...
                axios.post("/shaohuashuwu_war_exploded/userInfoController/isUserNameHaveByUsername/" +
                    ...
                    let Result2 = resp2.data;
                        if(Result2){
                            ...
                            axios.get("/shaohuashuwu_war_exploded/userInfoController/updateUserDataByID/" +
        ...
        updatePwd() {
            ...
            if (this.oldPwd === "") {
                ...
                if (this.oldPwd !== this.comparePwd) {//比对原密码
                    ...
                    axios.get("/shaohuashuwu_war_exploded/userInfoController/modifyPassword/" +
