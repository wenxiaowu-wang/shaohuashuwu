let authorVerifyManageInterface_vm = new Vue({
    ...
    methods:{
        ...
        becomeAnAuthorSubmit(){
            ...
            //发送成为作者的请求
            axios.post("/shaohuashuwu_war_exploded/userInfoController/addDoublePassword/"+this.pass).then(resp =>{
                if (resp.data){
                    this.$message({
                        type:'success',
        ...
        authorVerificationSubmit(){
            ...
            //发送作者登录验证的请求
            axios.post("/shaohuashuwu_war_exploded/userInfoController/isOldDoublePassword/"+this.pass).then(resp =>{
                if (resp.data){
                    this.$message({
                        type:'success',
        ...
        modifySecondaryPasswordSubmit(){
            //作者修改二级密码
            //发送修改二级密码请求
            axios.post("/shaohuashuwu_war_exploded/userInfoController/updateDoublePassword/"+this.oldPass+"/"+this.pass).then(resp =>{
                let str = resp.data;
