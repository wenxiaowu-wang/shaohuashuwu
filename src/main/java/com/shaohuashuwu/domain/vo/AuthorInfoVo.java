...
public class AuthorInfoVo  extends UserInfo  implements Serializable {
    ...
    private BigDecimal attention_num;  //关注数量attention_num
    private Long allwork_word_num; //作品总字数


    public AuthorInfoVo(Integer user_id, String user_name, String head_portrait, Integer ticket_num, BigDecimal attention_num, Long allwork_word_num) {
        super(user_id, user_name, head_portrait, ticket_num);
